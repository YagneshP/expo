...
public protocol AnyViewProp: AnyViewDefinitionElement {
  ...
  /**
   Whether this prop's value can be decoded straight from a JavaScript value on the
   JavaScript thread and the decoded result safely handed to the main-thread setter.
   See `AnyDynamicType.isJSThreadDecodable`.
   */
