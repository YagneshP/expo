...
/**
 ...
 or `nullptr` if nothing could be decoded (no app context, no view definition, etc.). Props
 whose types are not safe to decode on the JS thread are omitted and left for the legacy path.
